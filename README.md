...
| [`GR-pr`](skills/in-progress/GR-pr/) | Drafts one PR body per repo, iterates it with you, and opens each only once its text is approved. | The ready record is written and the branches are ready to publish. |
